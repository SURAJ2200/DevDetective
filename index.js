...
btnsubmit.addEventListener("click", function () {
  if (input.value !== "") {
     //getuser wala data what we search  
...
input.addEventListener(
  "keydown",
  function (e) {
    // when be press Enter key then search
    if (e.key == "Enter") {
      if (input.value !== "") {
        getUserData(url + input.value);
      }
...
// hide the no search result found data when new search enter in search bar
...
//   dark mode enable
// -> dark mode enable karna h 
  darkMode = true;
//   console.log("darkmode changed to " + darkMode);
  localStorage.setItem("dark-mod e", true); 
...
//   if not any value then by default light mode set karna bha
  if(value === null) {
    console.log("null k andar");
    localStorage.setItem("dark-mode", darkMode);
    lightModeProperties();
  }
//   dark mode set krna hai 
  else if(value == "true") {
    console.log("truer k andar");
    darkModeProperties();
  }
//   light mode set karna hai 
  else if(value == "false") {
